...
from roco_utils import load_mlm_data, train_one_epoch, validate, get_keywords, Model, ROCO, get_indexed_caption
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_dir', type=str, default = 'Weights/coco_mlm', help='save model weights in this dir', required = False)
